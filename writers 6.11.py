...
writer1 = writers('Александр Сергеевич Пушкин', 'Француз', '1799-1837', 'Российская Империя', '"Евгений Онегин", "Капитанская дочка","Дубровский"')
writer2 = writers('Лев Николаевич Толстой', 'псевдоним отсутствует', '1828-1910', 'Российская Империя', '"Анна Каренина", "Война и мир", "Кавказский пленник"')
work1 = work('Евгений Онегин', 'Александр Сергеевич Пушкин', 'АСТ', '1833')
